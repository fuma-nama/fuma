  ...
  return (
    ...
    >
      ...
      >
        <div
          ref={containerRef}
          className="absolute inset-0 hover-card-layer"
        ></div>
        <h2 className="font-bold text-neutral-50 text-6xl">Hello World</h2>
        <p>
          Hovering this card will give you an impressing experience. This card
          was inspired by Linear's customer page, their design is very inspiring
          and wonderful.
        </p>
      </div>
    </div>
